...
const unsigned long led_mask[] = {1UL << 10, 1UL << 11, 1UL<<12};
...
void LED_Init (void) {
  ...
  GPIOC->MODER   &= ~((3UL << 2*10) | (3UL << 2*11) | (3UL << 2*11));
  GPIOC->MODER   |=  ((1UL << 2*10) | (1UL << 2*11) | (1UL << 2*11));
  GPIOC->OTYPER  &= ~((1UL <<   10) | (1UL <<   11) | (1UL <<   11));
  GPIOC->OSPEEDR &= ~((3UL << 2*10) | (3UL << 2*11) | (3UL << 2*11));
  GPIOC->OSPEEDR |=  ((1UL << 2*10) | (1UL << 2*11) | (1UL << 2*11));
  GPIOC->PUPDR   &= ~((3UL << 2*10) | (3UL << 2*11) | (3UL << 2*11));
}
